...
BridgeSender::BridgeSender(std::shared_ptr<WSClient> client, WSClient::connection_ptr connection, std::string pcapPrefix)
    : client(std::move(client)), connection(std::move(connection)), dumper(pcapPrefix + "_output.pcap") {}
